  ...
  return (
    <div className="flex flex-row relative items-center justify-center min-h-screen w-full h-full -z-20 medical-section mx-4 my-8">
      ...
      <div className="flex flex-col items-center justify-center translate-y-[-50px] absolute z-[20] w-auto h-auto">
        ...
        <div className="Welcome-box px-[15px] py-[4px] z-[20] border my-[20px] border-[#dc26268B] opacity-[0.9]">
          <h1 className="Welcome-text text-[12px]">Medical Data Protection</h1>
        </div>
      </div>
